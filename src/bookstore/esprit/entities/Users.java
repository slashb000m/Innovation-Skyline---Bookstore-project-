...
public class Users {
   ...
   // enum Statut {Etudiant, Enseignant, Employé, Autre} ;  
    ...
    public Users(String nom, String prenom, String email, String password, String auteur_préféré, String genre_préféré, String statut, Date date_dinscription, int id_user) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
    ...
    public String toString() {
        return "Users{" + "nom=" + nom + ", prenom=" + prenom + ", email=" + email + ", auteur_préféré" + auteur_préféré + ", genre_préféré" + genre_préféré + ", statut=" + statut + ", date_dinscription=" + date_dinscription + ", id_user=" + id_user + '}';
    }
