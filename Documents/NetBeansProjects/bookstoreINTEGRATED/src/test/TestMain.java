...
public class TestMain {
   ...
   String str="2018-03-21";  
    Date date=Date.valueOf(str);//converting string into sql date  
       ...
       Users u1 = new Users("ala", "soltani", "eddineala344@gmail.com","123456","agatha christie", "Aventure", "Etudiant",date);
    ...
    //uc.ajouterReclamation(u1, r1);
        ...
        //System.out.println(ac.getDataForProportionCategorie());
        //System.out.println(ac.getLivresForReduction());
...
//  System.out.println(ac.getMailsFromUsers());
    }
